<div class="sidebar-wrapper active">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="<?= site_url('dashboard') ?>">
                    <img src="<?= base_url('assets/static/images/logo/logo.svg') ?>" alt="Logo">
                </a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item <?= (strpos(uri_string(), 'keys') !== false) ? 'active' : '' ?> has-sub">
                <a href="#" class='sidebar-link'>
                    <i class="bi bi-key-fill"></i>
                    <span>Keys</span>
                </a>
                <ul class="submenu <?= (strpos(uri_string(), 'keys') !== false) ? 'active' : '' ?>">
                    <li class="submenu-item <?= (uri_string() == 'keys') ? 'active' : '' ?>">
                        <a href="<?= site_url('keys') ?>" class="submenu-link">List Keys</a>
                    </li>
            ...
            <li class="sidebar-item <?= (uri_string() == 'Server') ? 'active' : '' ?>">
                <a href="<?= site_url('Server') ?>" class='sidebar-link'>
            ...
            <li class="sidebar-item <?= (strpos(uri_string(), 'admin') !== false && strpos(uri_string(), 'packages') === false) ? 'active' : '' ?> has-sub">
                ...
                <ul class="submenu <?= (strpos(uri_string(), 'admin') !== false && strpos(uri_string(), 'packages') === false) ? 'active' : '' ?>">
                    ...
                    <li class="submenu-item <?= (uri_string() == 'admin/create-referral') ? 'active' : '' ?>">
                        <a href="<?= site_url('admin/create-referral') ?>" class="submenu-link">Create Referral</a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
