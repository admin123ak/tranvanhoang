                                    ...
                                    <tbody>
                                        <?php foreach ($accounts as $acc): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-warning edit-bank-btn"
                                                            data-id="<?= esc($acc->id) ?>"
                                                            data-bank="<?= esc($acc->bank_name) ?>"
                                                            data-account="<?= esc($acc->account_number) ?>"
                                                            data-owner="<?= esc($acc->account_name) ?>"
                                                            data-token="<?= esc($acc->api_token ?? '') ?>"
                                                            data-status="<?= esc($acc->status) ?>">
...
document.addEventListener('click', function(e) {
    var btn = e.target.closest('.edit-bank-btn');
    if (btn) {
        e.preventDefault();
        var id = btn.getAttribute('data-id');
        var bankName = btn.getAttribute('data-bank');
        var accountNumber = btn.getAttribute('data-account');
        var accountName = btn.getAttribute('data-owner');
        var apiToken = btn.getAttribute('data-token');
