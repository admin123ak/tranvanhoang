    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Add new game package</p>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="package_name" id="package_name" class="form-control" placeholder="e.g. PUBG Mobile" value="<?= old('package_name') ?>" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="package_id" id="package_id" class="form-control" placeholder="e.g. com.tencent.ig" value="<?= old('package_id') ?>" required>
