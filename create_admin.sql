...
-- Tạo admin mới (không có cột user_ip vì bảng gốc special.sql không có)
INSERT INTO `users` (`username`, `password`, `fullname`, `level`, `status`, `saldo`, `uplink`, `created_at`, `updated_at`) VALUES (
  'admin123',
